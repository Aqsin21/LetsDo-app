...
namespace LetsDo.DAL.Migrations
{
    ...
    [Migration("20251205102707_BirthDate removed")]
    partial class BirthDateremoved
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LetsDo.DAL.DataContext.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LetsDo.DAL.DataContext.Entities.Event", b =>
                {
                    ...
                    b.HasOne("LetsDo.DAL.DataContext.Entities.AppUser", "Organizer")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("LetsDo.DAL.DataContext.Entities.AppUser", null)
                        .WithMany()
